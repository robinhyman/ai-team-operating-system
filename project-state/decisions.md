...
## 2026-08-14: Use A Project-Specific GitHub Repository

Decision: Each project using this operating system should have a GitHub repository and GitHub Project for issue tracking and observability.
...
Decision: Agent-managed issues should be added to the target GitHub Project and tracked with a custom `Agent Status` field.
